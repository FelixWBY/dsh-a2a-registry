...
/**
 * Read scope context while dispatching a slot whose declaration may be root-only.
 * @returns The installed binding, or null when no scope provider owns this tree.
 */
export function useOptionalScopeBinding(): StandardSourceBinding | null {
  return useContext(ScopeBindingContext)
}
